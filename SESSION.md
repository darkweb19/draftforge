...
- P06-T03 is green and done: documentation tests, typecheck, lint, build, package smoke, and the 2026-08-13 full repository check pass on this Windows/Node 24 host.
- Windows usage writes now serialize the JSONL append and derived aggregate refresh under the existing bounded project lock. Windows sharing violations during lock creation or inspection retry, while permanent denial and malformed lock data remain fail-closed.
